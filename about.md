...
- In terms of coursework, I've taken Post-Quantum Mathematical Cryptography (Maths department), Data Privacy (CS), Secure and Distributed Computation (CS), Machine Learning (CS), Abstract Algebra I: Group Theory (Maths) and Abstract Algebra III : Groups, Fields, some Rings and Galois Theory (Maths: focused on preparing Maths PhD students for Quals). I will be taking more Abstract Algebra II : Fields and Rings (Maths), along with a Random Probabilistic Graphs class (Maths), Algebra IV: Elliptic Curves (Maths), and sitting in on a Number Theory course (Maths) in Spring 2022 because why not.
