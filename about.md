...
- In terms of coursework, I've taken Post-Quantum Cryptography (Maths department), Data Privacy (CS), Secure and Distributed Computation (CS), Machine Learning (CS). I'm currently taking Abstract Algebra (focused on preparing Maths PhD students for Quals) and Information Theory (EE).
...
- In my experience, compared to my previous research focus, this topic takes a bit more time to produce a paper. I am okay with that. I am still a Computer Science PhD student...I think...(for now).
