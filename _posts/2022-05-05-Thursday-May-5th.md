...
- During the [CSRMP](https://research.google/outreach/csrmp/recipients/) project, I also relayed my progress with my mentor for this project. My mentor suggested the [template](https://medium.com/multiple-views-visualization-research-explained/data-is-personal-what-we-learned-from-42-interviews-in-rural-america-93539f25836d) [CHI paper](https://arxiv.org/abs/1901.01920) as a good fit for
this paper based on the topic.
- Unfortunately, I am not really interested in pursuing this work anymore (I would prefer to not pursue research in fairness and privacy at the moment, in favour of mathematical cryptography research, which is my true love and I'm very happy pursuing a career in!), so I thought I'd include slides I gave to the 2021 class in the hope that it might be helpful to someone pursuing this work. These are not all of my slides (some refer to specific cases we looked at in class, etc); some are confidential.
