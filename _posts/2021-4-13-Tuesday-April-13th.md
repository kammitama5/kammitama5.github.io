...
a new open source thing" that looks interesting. These days, he is into photography stuff and editing, so we talk a bit about open source programmes for that).
